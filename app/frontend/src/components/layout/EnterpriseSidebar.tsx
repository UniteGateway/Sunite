  ...
  const navGroups: SidebarNavGroup[] = [
    {
      ...
      items: [
        ...
        { title: 'Lead Pipeline', href: '/leads', icon: Building2 },
    ...
    },
    {
      ...
      items: [
        { title: 'Site Survey & Feasibility', href: '/survey', icon: Compass },
        { title: 'Solar Design & Calculator', href: '/engineering', icon: Calculator },
        { title: 'Dynamic Pricing Engine', href: '/pricing', icon: FileSpreadsheet },
        { title: 'Quotation Proposals', href: '/quotations', icon: FileCheck2 },
      ],
    },
    {
      ...
      items: [
        ...
        { title: 'Procurement POs', href: '/procurement', icon: ShoppingBag },
        { title: 'Inventory & Warehouses', href: '/inventory', icon: Boxes },
        { title: 'Finance & Commission', href: '/finance', icon: Wallet },
      ],
    },
    {
      title: 'AFTER-SALES & TELEMETRY',
      items: [
        { title: 'Warranty & Claims', href: '/warranty', icon: ShieldCheck },
        { title: 'AMC Contracts', href: '/amc', icon: Layers },
        { title: 'Field Service Tickets', href: '/service', icon: Wrench },
        { title: 'GenAI Solar Assistant', href: '/ai', icon: Bot },
    ...
    },
    {
      ...
      items: [
        { title: 'Audit & System Settings', href: '/settings', icon: Settings },
        { title: 'User & RBAC Access', href: '/admin', icon: UserCog },
      ],
    },
  ];
